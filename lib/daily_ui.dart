...
class DailyUi extends StatefulWidget {
  const DailyUi({super.key, required this.prefs, required this.callClient});

  final SharedPreferences prefs;
  final CallClient callClient;

  @override
  State<DailyUi> createState() => _DailyUiState();
}

class _DailyUiState extends State<DailyUi> {
